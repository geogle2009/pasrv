...
public class RSAEncrypt {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("随机生成的公钥为:" + RsaUtils.pubkey);
		System.out.println("随机生成的私钥为:" + RsaUtils.prikey);
		
		/*公钥加密*/
		String messageEn = encrypt(message, RsaUtils.pubkey);
		System.out.println(message + "\t加密后的字符串为:" + messageEn);
		/*私钥解密*/
		String messageDe = decrypt(messageEn, RsaUtils.prikey);
